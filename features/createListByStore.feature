Feature: Gerar lista de compras de uma determinada loja que possui seções      
  ...
  Scenario: Cria lista de loja
    ...
    And para a seção "Frios" em "Mercadinho" foi associado o produto "Queijo Coalho" com preço "5.50"
      When eu solicito a criação da lista exclusiva para "Mercadinho"
        Then o arquivo "Mercadinho.pdf" é enviado
        And a seção "Frios" aparece com os itens "Queijo Coalho" "5.50" e "Mortadela" "2.45"
  ...
  #Cenario 1:
  Scenario: Cria lista de Loja pela GUI
    Given a loja "Mercadinho" está registrada no sistema
    ...
    And estou na página "newListByStore"
      ...
      And seleciono a opção "baixar"
        Then o arquivo "Mercadinho.pdf" é enviado
        And vejo uma lista com os itens "Vassoura" "3.40", "Mortadela" "2.45" e "Queijo" "5.50"
  ...
  #Cenario 2:
  Scenario: Cria lista de loja quando não há itens em falta pela GUI
